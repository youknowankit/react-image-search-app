function ImageCard({ src, alt, onClick }) {
  return (
    <div
      ...
      onClick={onClick} //event bubbling overlay receives the click-> bubble-> div has handler
    >
      <img
        src={src}
        alt={alt}
        className="h-60 w-full object-cover group-hover:scale-105 transition duration-300"
        // onClick={onClick} onClick here will only work if overlay has pointer-events-none
      />
